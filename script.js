window.goToPage = function() {
  ...
  const [lieferpostleitzahl, rechnungspostleitzahl] = document.getElementsByClassName('postleitzahl');
  const [lieferhausnummer, rechnungshausnummer] = document.getElementsByClassName('hausnummer');
  const [lieferstraße, rechnungsstraße] = document.getElementsByClassName('straße');
  const score =
